...
from ExusiaiBot.modules.sql.locales_sql import switch_to_locale, prev_locale
from ExusiaiBot.modules.tr_engine.strings import tld, LANGUAGES
from telegram.ext import CommandHandler
from telegram import ParseMode, InlineKeyboardMarkup, InlineKeyboardButton
from ExusiaiBot import dispatcher
from ExusiaiBot.modules.tr_engine.list_locale import list_locales
...
def locale_button(bot, update):
    ...
    if lang_match := re.findall(r"en-US|en-GB|id|ru|es", query.data):
        if lang_match[0]:
