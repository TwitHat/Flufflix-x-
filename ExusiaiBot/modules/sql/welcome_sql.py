...
from ExusiaiBot.modules.helper_funcs.msg_types import Types
from ExusiaiBot.modules.sql import SESSION, BASE
...
class UserRestirect(BASE):
    ...
    def __repr__(self):
        return f"<User restirect '{self.user_id}' in {self.chat_id}>"
